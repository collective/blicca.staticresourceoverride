...
Install it into the project's virtualenv (e.g. from the project's backend
directory: `uv pip install -e ../blicca.staticresourceoverride`, or add it
to the project's dependencies), restart the backend and install **"Blicca
Static Resource Override (Training)"** in the add-ons control panel.
